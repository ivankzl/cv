...
public class ProduccionController {
	...
	@Autowired
	public void setProduccionService(ProduccionService prduccionService) {
		this.produccionService = produccionService;
	}
	
	@RequestMapping(value="/crearproduccion", method=RequestMethod.POST)
	public String creaProduccion(Model model, @Valid Produccion produccion, BindingResult result) {
		if (result.hasErrors()){
		...
		model.addAttribute("articulos_revista_con_referato", produccion.getArticulos_revistas_con_referato());
		model.addAttribute("articulos_revista_sin_referato", produccion.getArticulos_revistas_sin_referato());
