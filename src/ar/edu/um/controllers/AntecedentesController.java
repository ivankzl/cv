...
public class AntecedentesController {
	...
	public String creaDatos(Model model, @Valid Antecedentes antecedentes, BindingResult result) {
		if (result.hasErrors()){
		...
		model.addAttribute("ejercicio_profesional_ambito_no_academico", antecedentes.getEjercicio_profesional_ambito_no_academico());
