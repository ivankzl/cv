	...
	<img src="resources/imagenes/marca.png">
		<div class="well">
			<div class="container">
				<div class="row">
					<div class="col-lg-6">
						<form:form id="loginForm" class="form-horizontal" method="post" action="<c:url value='/j_spring_security_check'/>" >
						...
						<form:form id="registration-form" class="form-horizontal" method="post"
							action="${pageContext.request.contextPath}/registro" modelAttribute="user">
