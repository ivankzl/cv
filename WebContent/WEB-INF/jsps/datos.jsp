			...
			<div class="container">
				...
				<p>
					<a class="btn btn-primary btn-lg" href="#" role="button">Datos
						Personales</a> <a class="btn btn-default btn-lg" href="#"
						role="button">Formación</a> <a class="btn btn-default btn-lg"
						href="#" role="button">Cargos</a> <a
						class="btn btn-default btn-lg" href="#" role="button">Antecedentes</a>
				...
				<form:form id="registration-form" class="form-horizontal"
					method="post"
					action="${pageContext.request.contextPath}/crearegistro"
					...
					<div class="form-group">
						<div class="dropdown">
							...
							<input path="alu_doc_id" id="alu_doc_id" type="hidden"
								name="alu_doc_id" value="${alu_doc_id}">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<input path="alu_dni" id="alu_dni" type="hidden" name="alu_dni"
							value="${alu_dni}">
					</div>
					...
					<div class="form-group">
						<label for="inputName">Nombre</label> <input type="text"
							id="alu_nombre" class="form-control" path="alu_nombre"
							name="alu_nombre" placeholder="Nombre">
						<form:errors cssClass="error" path="alu_nombre"></form:errors>
					</div>

					<!-- APELLIDO -->
					<div class="form-group">
						<label for="inputApellido">Apellido</label> <input type="text"
							class="form-control" id="alu_apellido" path="alu_apellido"
							name="alu_apellido" placeholder="Apellido">
						<form:errors cssClass="error" path="alu_apellido"></form:errors>
					</div>
					...
					<div class="form-group">
						<label for="inputEmail">Email</label> <input type="email"
							class="form-control" id="alu_email" path="alu_email"
							name="alu_email" placeholder="Email">
					...
					<div class="form-group">
						...
						<form:errors cssClass="error" path="alu_telefono"></form:errors>
					</div>
					...
					<div class="form-group">
						...
						</select> <select class="form-control" id="mes" name="mes">
							<option>- Mes -</option>
					...
					<div class="form-group">
						...
						<form:errors cssClass="error" path="alu_domicilio"></form:errors>
					</div>
